...
Source: "OnlyT\bin\Release\hu-HU\*.dll"; DestDir: "{app}\hu-HU"; Flags: ignoreversion
...
Source: "OnlyT\bin\Release\ko-KR\*.dll"; DestDir: "{app}\ko-KR"; Flags: ignoreversion
;Source: "OnlyT\bin\Release\lv-LV\*.dll"; DestDir: "{app}\lv-LV"; Flags: ignoreversion
...
Source: "OnlyT\bin\Release\uk-UA\*.dll"; DestDir: "{app}\uk-UA"; Flags: ignoreversion
Source: "OnlyT\bin\Release\vi-VN\*.dll"; DestDir: "{app}\vi-VN"; Flags: ignoreversion
